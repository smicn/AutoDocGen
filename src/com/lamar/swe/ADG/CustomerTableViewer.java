 ...
 * /misc/TablePrintDemo3Project/src/misc/TablePrintDemo3.java
 * */
...
public class CustomerTableViewer extends JFrame {
    ...
    public static void launch() {
    	new CustomerTableViewer().setVisible(true);
    }
